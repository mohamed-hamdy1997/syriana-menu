...
<div class="container logo">
    ...
    <div class="row">
        <div class="col-10"><img src="{{asset('images/logo.png')}}" alt=""></div>
        <div class="col-2">
                ...
                <div style="height :900px; margin-top: 65px;">
                    @foreach($category->products as $product)
                        <div class="aligned"
                             ...
                             onclick="showPopup({{ $product }}, '{{ Storage::url($product->image) }}')">
                            <a href="#blackout"><img src="{{ Storage::url($product->image) }}" class="card-img-top"
                                                     alt="{{$product->name}}"
...
<div class="footer">
    <div class="container-fulide">
        <p class="copyright">Made With &lt;3 By.....</p>
    </div>
</div>
